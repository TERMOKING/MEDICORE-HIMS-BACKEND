...
export class DoctorsService {
    ...
    async update(
        ...
        if (
            updateDoctorDto.medicalRegistrationNumber !== undefined
        ) {
        ...
        if (updateDoctorDto.isAvailableToday !== undefined) {
            updateData.isAvailableToday =
                updateDoctorDto.isAvailableToday;
        }
